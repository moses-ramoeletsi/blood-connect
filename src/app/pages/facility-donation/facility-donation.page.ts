...
@Component({
  selector: 'app-facility-donation',
  templateUrl: './facility-donation.page.html',
  styleUrls: ['./facility-donation.page.scss'],
})
export class FacilityDonationPage implements OnInit {
  donationForm = {
    name: '',
    address: '',
    phoneNumber: '',
